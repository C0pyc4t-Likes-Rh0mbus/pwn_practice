...
char* EXE = "/Users/user/Documents/git/pwn_practice/wkr/input2/input";
int main(int argc, char* argv[]){
	...
	new_stdin = open("./first", O_CREAT|O_RDWR, 0777);
	write(new_stdin, "\x00\x0a\x00\xff", 4);
	
	new_stderr = open("./second", O_CREAT|O_RDWR, 0777);
	...
	int newline = open("./\x0a", O_CREAT|O_RDWR, 0777);
